...
Post é um mensageiro de **estado dual**:
...
No MVP atual, essas convenções já foram aplicadas na UI principal de `templates/post/index_post.html`.
...
- Headers: `Authorization`, `X-Post-Mode`, `X-ZIOS-Intelligent`
